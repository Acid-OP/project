  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Add the missing text colors here
        baseTextHighEmphasis: "rgb(244,244,246)", // Moved from borderColor
        baseTextMedEmphasis: "rgb(156,163,175)", // Added - equivalent to gray-400
      ...
      borderColor: {
        ...
        baseBorderFocus: "rgb(156,163,175)",
      },
      textColor: {
        greenPrimaryButtonText: "rgb(20,21,27)",
        redPrimaryButtonText: "rgb(244,244,246)",
        baseTextHighEmphasis: "rgb(244,244,246)",
        baseTextMedEmphasis: "rgb(156,163,175)",
        greenText: "rgb(0,194,120)",
        redText: "rgb(234,56,59)",
      },
      backgroundImage: {
